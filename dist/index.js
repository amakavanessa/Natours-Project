...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWFrc2JhYnkiLCJhIjoiY2w1N2Y3MmxuMGY2czNqbnMzbHBhdnZ2eCJ9.w_ijxNuSpG4VzDXbP__CeQ';
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          console.log(_context2.t0.name, _context2.t0.message);
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"pay.js":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _axios.default)("/api/v1/bookings/bookTour/".concat(tourId));
        case 3:
          session = _context.sent;
          url = session.data.data.authorization_url; //2)redirect to authorization url
...
var userSideMenu = document.querySelector('.user-view__menu');
var userContent = document.querySelector('.user-view__content');
var mobileSideMenu = document.querySelector('.sideMenu');
// DELEGATION
if (mapBox) {
